        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              Krisumi Corporation is a landmark joint venture between Sumitomo Corporation (Fortune 500, Japan) and Krishna Group, India. With a legacy of successfully delivering ~1 million sq.ft across 433 apartments, Krisumi continues to redefine ultra-luxury living through Japanese design principles, craftsmanship, and an unwavering commitment to quality.</p>
            ...
            <div style={{ background: 'var(--color-gold-bg)', borderRadius: '10px', border: '1px solid var(--color-gold-light)', padding: '12px 16px', marginBottom: '20px' }}>
              ...
              {[
                { role: 'Architecture', name: 'Nikken Sekkei (Japan)' },
                { role: 'Interiors', name: 'A.N.D.' },
                { role: 'Landscape', name: 'STGK' },
              ].map((d, i) => (
