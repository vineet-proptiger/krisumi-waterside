            ...
            >
              {slides.map((src, idx) => (
                <div key={idx} style={{ width: `${100 / slides.length}%`, flexShrink: 0, position: 'relative' }}>
                  <Image src={src} alt={`Krisumi Waterside ${idx + 1}`} fill className="object-cover"
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            <div style={{
              ...
              {[
                ...
                { value: '₹30 Lacs*', label: 'Booking Starts at' },
              ].map((s, i) => (
                <div key={i} style={{
                  textAlign: 'center',
                  padding: '8px 6px',
...
//               <span style={{ color:'var(--color-gold)', fontWeight:600 }}>new‑launch</span>{' '}
...
//             {[
//               { val:'33',        lbl:'Acres\nTownship'   },
//               { val:'3 & 4 LDK', lbl:'Config-\nuration'  },
//               { val:'25:25:50',  lbl:'Payment\nPlan'     },
//               { val:'₹41 L*',    lbl:'EOI Non-\nBankable' },
//             ].map((s, i) => (
//               <div key={i} style={{
//                 padding:'14px 16px',
...
//               'Two Iconic Skyline Towers',
//               'Cascades Club — 1.6 Lakh* sq. ft.',
//               'Fusion of Indo‑Japanese Artistry',
